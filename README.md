...
Attention, cela nécessite d'ajouter un `ifndef` à votre header, qui définira la valeur du nombre maximal de fichiers gérables par votre fonction. Ce nombre varie en fonction de l'ordinateur sur lequel elle est appelée. Pour vous assurer que votre fonction bonus fonctionne sur chaque ordinateur, utilisez .
